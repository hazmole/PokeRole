...
return text;}
function cmpMove(a,b){if(a.rank!=b.rank)return a.rank>b.rank?1:-1;if(a.type!=b.type)return(a.type=="Normal")?-1:(b.type=="Normal")?1:(a.type>b.type?1:-1);return a.name>b.name?1:-1;}}}

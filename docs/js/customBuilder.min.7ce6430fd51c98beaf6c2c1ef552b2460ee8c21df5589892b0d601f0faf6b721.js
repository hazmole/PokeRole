...
function getIconHTML(tagArr){var icon_type=tagArr[0];var icon_size=getSizeClass(tagArr[1]);switch(icon_type){case "lethal":return getHTML_normalIcon("lethalDamage",icon_size);case "novice":return getHTML_normalIcon("NoviceMark",icon_size);case "dice":return getHTML_diceIcon(icon_size,tagArr[2]);case "rdice":return getHTML_rdiceIcon(icon_size,tagArr[2],tagArr[3]);case "frame":return getHTML_frame(tagArr.slice(1));default:return "<b>[Unknown token]</b>";}}

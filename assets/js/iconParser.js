...
class IconParser {
  ...
  static getIconHTML( tagArr ){
    ...
    switch(icon_type){
      ...
      case "mdice":  return this.getHTML_mdiceIcon(icon_size, tagArr[2]);
  ...
  static getHTML_mdiceIcon(iconSize, number){
    return `<tag class="dice minus ${iconSize}"><b>${number}</b></tag>`;
  }

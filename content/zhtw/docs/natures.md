...
{{< nature "Adamant" 4 "Powerful, Fierce, Relentless" >}}
...
{{< nature "Bashful" 6 "Compassionate, Vulnerable, Family Oriented" >}}
...
{{< nature "Bold" 9 "Adventurous, Confident, Daring" >}}
...
{{< nature "Brave" 9 "Fearless, Level-headed, Protector" >}}
...
{{< nature "Calm" 8 "Reasonable, Peaceful, Balanced" >}}
...
{{< nature "Careful" 5 "Analytic, Skeptical, Withdrawn" >}}
...
{{< nature "Docile" 7 "Kind, Team worker, Service spirit" >}}
...
{{< nature "Gentle" 10 "Graceful, Charismatic, Extroverts" >}}
...
{{< nature "Hardy" 9 "Dependable, Resilient, Resourceful" >}}
...
{{< nature "Hasty" 7 "Eager, Enthusiastic, Hustle" >}}
...
{{< nature "Impish" 7 "Mischievous, Witty, Playful" >}}
...
{{< nature "Jolly" 10 "Cheerful, Charming, Energetic" >}}
...
{{< nature "Lax" 8 "Unconcerned, Indolent, Simple" >}}
...
{{< nature "Lonely" 5 "Independent, Introspective, Solitary" >}}
...
{{< nature "Mild" 8 "Meek, Serene, Comforting" >}}
...
{{< nature "Modest" 10 "Measured, Self-Assured, Hard Worker" >}}
...
{{< nature "Naive" 7 "Curious, Lighthearted, Innocent" >}}
...
{{< nature "Naughty" 6 "Devious, Rebel, Sly" >}}
...
{{< nature "Quiet" 5 "Silent, Reserved, Espectator" >}}
...
{{< nature "Quirky" 9 "Unusual, Open-Minded, Original" >}}
...
{{< nature "Rash" 6 "Reckless, Unrefined, Daredevil" >}}
...
{{< nature "Relaxed" 8 "Carefree, Meditative, Nonchalant" >}}
...
{{< nature "Sassy" 7 "Lively, Irreverent, Mouthy" >}}
...
{{< nature "Serious" 4 "Steadfast, Rigid, Commited" >}}
...
{{< nature "Timid" 4 "Shy, Apprehensive, Sensible" >}}
...
<script type="text/javascript">
  function appendToC(){
    var natureList = Object.values(document.getElementsByClassName("Nature")).map(n => n.children[0].innerText);
